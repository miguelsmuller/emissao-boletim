...
<div class="card-header card-header-inverse">
    ...
    <h4>Graus de Escolaridade</h4>
    </div>
    <div class="card-header-buttons">
    <a class="btn btn-small btn-primary" href="{{ URL::route('formularioGrauEscolaridade') }}">Adicionar</a>
          ...
          <td style="text-align: right;">
            <div class="dropdown" data-dropdown="true">
              ...
              <div class="dropdown-content">
                  ...
                  <li><a href="{{ URL::route('formularioGrauEscolaridade', $registro->id) }}">Editar</a></li>
                  <li><a href="{{ URL::route('excluirGrauEscolaridade', $registro->id) }}">Excluir</a></li>
                  <li><a href="{{ URL::route('listarGradeCurricular', $registro->id) }}">Grade Curricular</a></li>
                  </ul>
              </div>
              </div>
          </td>
