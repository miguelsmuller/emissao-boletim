...
<div class="card-header card-header-inverse">
    ...
    <div class="card-header-buttons">
        <a class="btn btn-small btn-primary" href="{{ URL::route('formularioComponenteCurricular') }}">Adicionar</a>
          ...
          <td style="text-align: right;">
            <div class="dropdown" data-dropdown="true">
              ...
              <div class="dropdown-content">
                  ...
                  <li><a href="{{ URL::route('formularioComponenteCurricular', $registro->id) }}">Editar</a></li>
                  <li><a href="{{ URL::route('excluirComponenteCurricular', $registro->id) }}">Excluir</a></li>
                  </ul>
              </div>
              </div>
          </td>
