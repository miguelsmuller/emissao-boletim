...
<div class="card-header card-header-inverse">
    ...
    <div class="card-header-buttons">
        <a class="btn btn-small btn-primary" href="{{ URL::route('formularioEscola') }}">Adicionar</a>
...
<div class="card-body">
  <div class="table-responsive">
    <table id="tblListagem" class="table table-striped table-bordered table-hover table-sm responsive">
      ...
      @foreach($listagem as $registro)
        <tr>
          <td>{{ $registro->idINEP }}</td>

          <td>{{ $registro->nomeCompleto }}</td>

          <td>{{ $registro->nomeReduzido }}</td>
          ...
          <td style="text-align: right;">
            <div class="dropdown" data-dropdown="true">
              ...
              <div class="dropdown-content">
                  ...
                  <li><a href="{{ URL::route('formularioEscola', $registro->id) }}">Editar</li>
                  <li><a href="{{ URL::route('excluirEscola', $registro->id) }}">Excluir</li>
                  </ul>
              </div>
              </div>
          </td>
